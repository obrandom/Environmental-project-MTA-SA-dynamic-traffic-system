...
-- =============================================================================
-- HONKING SYSTEM - Event-driven (OPTIMIZED: no more polling)
-- =============================================================================

-- React only when horn state actually changes (via elementData)
addEventHandler("onClientElementDataChange", root, function(key, oldVal, newVal)
	if key == "npc.honking" and getElementType(source) == "ped" then
		setPedControlState(source, "horn", newVal or false)
	end
end)
